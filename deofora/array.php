...
<html>
    <head>
        ...
        <link href="css/array.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <main>
            <div id="contenedorarray">
            <input id="boton_array" name="submit" type="button" value="Introducir catacterísticas" onclick="cargarCampos()">
            <input id="boton_array1" name="submit" type="button" value="Generar productos" onclick="cargarDatos()">
              <input id="boton_array2" name="submit" type="button" value="Mostrar Tabla" onclick="mostrarTabla()">
           </div>
        </main>
        <footer>
